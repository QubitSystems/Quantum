...
<body>
        ...
        <div class="iq-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="home.html"><img class="img-fluid" src="images/quantum-color.png" alt="logo"></a>
                        </div>
    ...
    <section class="overview-block-ptb iq-feature-aria">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ul class="filters">
                        <li>
                            <a href="#" class="filter active" data-filter="opportunity">Oportunidad</a>
                        </li>
                        <li>
                            <a href="#" class="filter" data-filter="service">Servicios</a>
                        </li>
                        <li>
                            <a href="#" class="filter" data-filter="contact">Contacto</a>
                        </li>       
                        <li>
        ...
        <div class="portafolio-items 2-cols">
            <div class="container">
                <div id="grid">
                    <div class="mix item col-md-6 about" style="border:2px solid;">
