...
<body>
    ...
    <section class="iq-bg iq-bg-fixed iq-over-black-80 jarallax iq-breadcrumb text-center iq-font-white" style="background-image: url('images/quantum.jpg'); background-position: center center;">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="heading-title">
                        <h3 class="title text-uppercase iq-font-white iq-tw-6">Quantum</h3>
                    </div>
                    <p>El sector financiero la industria que más dinero mueve en el mundo representa la oportunidad que estabas buscando para mejorar tu economía y alcanzar tu libertad financiera</p>
                </div>
            </div>
        </div>
    ...
    <section class="cards clearfix">
          ...
          <article class="card post-38 post type-post status-publish format-standard hentry category-non-classe">
      <a class="card--link"  data-transition="home-into-single">
        <div class="card--headline">
          <div class="scroll-parallax" para-strength="-1">
            <h3 class="card--title"></h3>
            <h4 style="color:white" class="card--subtitle">"Atención impecable <br>al cliente"</h4>
          </div>
        </div>

        <div class="card--number" style="color:#47effc">01</div>
        <div class="card--stroke" style="background:#47effc"></div>
      ...
      <div class="card--bigtitle">
        <div class="scroll-parallax" para-strength="-3"></div>
          ...
          <article class="card post-10 post type-post status-publish format-standard hentry category-non-classe">
      <a class="card--link"  data-transition="home-into-single">
        <div class="card--headline">
          <div class="scroll-parallax" para-strength="-1">
            <h3 class="card--title"></h3>
            <h4 style="color:white" class="card--subtitle">"Comunicación fluida <br>y transparente con <br>nuestros clientes"</h4>
          </div>
        </div>

        <div class="card--number" style="color:#ffda0e">02</div>
        <div class="card--stroke" style="background:#ffda0e"></div>
      ...
      <div class="card--bigtitle">
        <div class="scroll-parallax" para-strength="-3">pilar 2</div>
          ...
          <article class="card post-13 post type-post status-publish format-standard hentry category-non-classe">
      <a class="card--link"  data-transition="home-into-single">
        <div class="card--headline">
          <div class="scroll-parallax" para-strength="-1">
            <h3 class="card--title"></h3>
            <h4 style="color:white" class="card--subtitle">"Compromiso con <br>sus metas y objetivos"</h4>
          </div>
        </div>

        <div class="card--number" style="color:#4a7efb">03</div>
        <div class="card--stroke" style="background:#4a7efb"></div>
      ...
      <div class="card--bigtitle">
        <div class="scroll-parallax" para-strength="-3">pilar 3</div>
          ...
          <article class="card post-28 post type-post status-publish format-standard hentry category-non-classe">
      <a class="card--link"  data-transition="home-into-single">
        <div class="card--headline">
          <div class="scroll-parallax" para-strength="-1">
            <h3 class="card--title"></h3>
            <h4 style="color:white" class="card--subtitle">"Aportar con experiencias<br> de alto valor a las<br> personas involucradas"</h4>
          </div>
        </div>

        <div class="card--number" style="color:#f1b4a6">04</div>
        <div class="card--stroke" style="background:#f1b4a6"></div>
      ...
      <div class="card--bigtitle">
        <div class="scroll-parallax" para-strength="-3"> pilar  4</div>
          ...
          <article class="card post-24 post type-post status-publish format-standard hentry category-non-classe">
      <a class="card--link"  data-transition="home-into-single">
        <div class="card--headline">
          <div class="scroll-parallax" para-strength="-1">
            <h3 class="card--title"></h3>
            <h4 style="color:white" class="card--subtitle">"Responsabilidad<br> y profesionalismo"</h4>
          </div>
        </div>

        <div class="card--number" style="color:#e8501b">05</div>
        <div class="card--stroke" style="background:#e8501b"></div>
      ...
      <div class="card--bigtitle">
        <div class="scroll-parallax" para-strength="-3">pilar 5</div>
          ...
          <article class="card post-26 post type-post status-publish format-standard hentry category-non-classe">
      <a class="card--link"  data-transition="home-into-single">
        <div class="card--headline">
          <div class="scroll-parallax" para-strength="-1">
            <h3 class="card--title"></h3>
            <h5 style="color:white" class="card--subtitle">"Comportamiento ético<br> y Transparente"</h5>
          </div>
        </div>

        <div class="card--number" style="color:#ffd973">06</div>
        <div class="card--stroke" style="background:#ffd973"></div>
